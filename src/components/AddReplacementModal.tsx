...
export default function AddReplacementModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ALTERAÇÃO: Removida a criação automática da fração para "FULL".
      // A reposição será criada pendente (0/50), e o usuário deverá completá-la manualmente no card.
        ...
        <div className="flex items-start justify-between px-6 pt-5 pb-3 border-b border-slate-700">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Crie a sessão. Ela será criada pendente e deve ser completada no card.
            </p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500">
              A sessão iniciará vazia. Você deverá entrar no card para completar.
            </p>
          </div>

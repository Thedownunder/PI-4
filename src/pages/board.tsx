...
function BoardInner({ onLogout }: BoardPageProps) {
  ...
  useEffect(() => {
    ...
    // CORREÇÃO: Dependências removidas para evitar loop de cancelamento
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);

  /* ------------------- SUPABASE REALTIME SUBSCRIPTION ------------------- */
  useEffect(() => {
    // Canal para ouvir mudanças na tabela 'patients'
    ...
    // Canal para ouvir mudanças na tabela 'replacements'
    const replacementsChannel = supabase
      .channel("replacements-channel")
      .on(
        "postgres_changes",
    ...
    // CORREÇÃO: Dependências removidas para evitar reconexão constante
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
